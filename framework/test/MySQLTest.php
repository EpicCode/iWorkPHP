...
class MySQLTest extends PHPUnit_Framework_TestCase {
    ...
    public function checkFiles() {
        $this->assertTrue(file_exists($this->config->getParam('databaseDir') . 'Entity/User.php'));
        $this->assertTrue(file_exists($this->config->getParam('databaseDir') . 'Entity/Info.php'));
    }
